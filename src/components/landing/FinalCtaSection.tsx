    ...
    <section className="py-20 sm:py-32 px-4 sm:px-6 lg:px-8 border-t border-zinc-800/60 bg-gradient-to-b from-[#080A10] to-[#040609] relative overflow-hidden text-center">
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-4">
          ...
          <button
            onClick={onSignIn}
            className="w-full sm:w-auto px-6 py-4 bg-zinc-900 hover:bg-zinc-800 text-zinc-200 text-sm font-semibold rounded-2xl border border-zinc-700 shadow-lg hover:border-zinc-600 transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
